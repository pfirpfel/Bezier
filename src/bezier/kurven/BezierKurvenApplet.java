...
public class BezierKurvenApplet extends JApplet {
    ...
    //Variablen
    private int zaehler = 0,bezierKurvenzaehler=0; //zählt die erstellten Punkte
...
//        contentPane.add(menu,BorderLayout.NORTH);
    ...
    private void createPopupMenu() {
        ...
        popup.add(menuKurve);
        menuKurveerweitern = new JMenuItem("Bézier Kurve zeichnen");
        menuKurveerweitern.addMouseListener(new MouseAdapter() {
            @Override
            public void mousePressed(MouseEvent event) {
                //Aktion    bezierKurven[bezierKurvenzaehler]
            }
        });
